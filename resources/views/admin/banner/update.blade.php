...
<div class="p-5">
    <div class="card p-2">
        ...
        <hr>
        <form action="{{route('updateBanner',$banner->id)}}" enctype="multipart/form-data"  method="POST">
            @csrf
            @method('PUT')
            <div class="col">
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{$banner->name}}" class="form-control" name="name" placeholder="nhập tên sản phẩm">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file"  value="uploads/{{$banner->name}}" name="file_upload">
                        @error('name')
                        <span style="font-size: 14px;color: red;font-weight: 400">{{$message}}</span>
                        @enderror
                    </div>
