<div class="sidebar__sale">
    ...
    <ul class="list-group border">
        ...
        <li class="list-group-item "><a href="{{route('productCategory',$item->id)}}" style="text-decoration: none;color: #000;display: block;padding:10px">{{$item->name}}</a>
        </li>
        @endforeach
    </ul>
</div>
<div class="product_sale mt-3">
    ...
    @if ($loop->index < 4) <div class="card-item border" style="height: 70px;display: flex">
        <div class="card-image " style="height: 100%; width: 30%;">
            <a class="p-2" style="display: block;height: 100%;" href="{{route('productDetail',$item->id)}}"> <img src="/uploads/{{$item->image}}" style="width: 100%; height: 100%;object-fit: contain"></a>
        </div>
