            ...
            <div class="cart-index">
                ...
                <div class="tbody text-center d-flex flex-wrap">
                    <div class="col-xs-12 col-12 col-sm-12 col-md-9 col-lg-9">
                                        ...
                                        <tr productId={{ $id }}>
                                            ...
                                            <td style="width: 8%;">
                                                <div class="quantity clearfix">
                                                    <input name="quantity" id="27" class="form-control"
                                            ...
                                            <td>
                                                <button style="color: #fff" class="delete-product btn btn-primary"
                        ...
                        <a href="{{ route('products') }}" style="border-radius:0px" class="btn btn-primary">Tiếp tục mua
                            hàng
                        </a>
                    </div>
