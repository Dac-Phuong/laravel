    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--begin::Form-->
                <div class="card">
                    <h5 class="card-header">Sửa thông tin banner</h5>
                    <div class="card-body">
                        <form wire:submit.prevent="submit" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label" for="bs-validation-name">Tên banner</label>
                                <input type="text" class="form-control" wire:model.defer="name"
                                    id="bs-validation-name" placeholder="Nhập tên banner">
                                @error('name')
